...
samples_batch_2 = list('35171_CV005_RV9039361',
...
for (sample in samples)
{
  ...
  annot_path = paste('/home/jovyan/notebooks/Vento_Lab/CVID/202009_new_analysis_revision/CITE_all_samples_analysis/annot_tables_for_SoupX/20201217_prelim_annot_all_samples_annot_sample_', sample, '.csv',
                     sep = "")
  ...
  save_path = paste('/lustre/scratch117/cellgen/team292/aa22/adata_objects/202009_CVID_revision/202012_counts_denoised_with_SoupX_sample_', sample, '.csv',
                    sep = "")
